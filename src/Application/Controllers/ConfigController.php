...
class ConfigController
{
    ...
    private function loadSystemInfo(): array
    {
        ...
        $systemInfo = [
            ...
            'maintainer' => $globalConfig['NAME'] ?? 'System Administrator',
            'callsign' => $globalConfig['CALL'] ?? 'CALLSIGN',
            'location' => $globalConfig['LOCATION'] ?? 'Your Location',
            'title2' => $globalConfig['TITLE2'] ?? 'ASL3+ Management Dashboard',
            'title3' => $globalConfig['TITLE3'] ?? 'AllStarLink/IRLP/EchoLink/Digital - Bridging Control Center',
