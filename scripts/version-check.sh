...
echo "==================="
echo "Supermon-NG installs and updates via the Debian package (apt)."
echo "To update to the latest release:"
echo "  sudo apt update"
echo "  sudo apt install supermon-ng"
echo ""
echo "See /var/www/html/supermon-ng/docs/DEBIAN.md for APT repository setup."
