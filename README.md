...
```bash
# Installation
cd $HOME && wget https://github.com/hardenedpenguin/supermon-ng/releases/download/V4.2.0/supermon-ng-V4.2.0.tar.xz
tar -xJf supermon-ng-V4.2.0.tar.xz && cd supermon-ng && sudo ./install.sh

# Update
cd $HOME && wget https://github.com/hardenedpenguin/supermon-ng/releases/download/V4.2.0/supermon-ng-V4.2.0.tar.xz
tar -xJf supermon-ng-V4.2.0.tar.xz && cd supermon-ng && sudo ./scripts/update.sh
